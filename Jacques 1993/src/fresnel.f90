...
CONTAINS
   ...
   use tauint, only : tauint2

   implicit none
        

   real n1,n2,n,tir,cost2,f1,f2,xcur,ycur,xmax,ymax,zmax
   real ran2,costt,crit,ran,weight,ddx,ddy,delta
   ...
   !           photon reflected
      ...
      ,tflag,iseed,delta,sflag,weight,ddx,ddy,0)
   else
   !photon transmitted
   if(nzp.gt.0.)then
   ix=floor(xcur/ddx)
