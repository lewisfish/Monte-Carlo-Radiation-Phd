...
CONTAINS
   subroutine binning(xmax,ymax,zmax,ddz,xcur,ycur,zcur, absorb)
   ...
   real    :: zmax,ddr,ddz,xcur,ycur,zcur,xmax,ymax,absorb
...
!   else
      ...
      deposit(celli,cellj,cellk) = deposit(celli,cellj,cellk) + absorb
!   end if
